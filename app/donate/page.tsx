    ...
    <div className="min-h-screen bg-white">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex justify-center mb-8">
                    <div className="bg-gray-100 rounded-full p-1 flex">
                      <button
                        ...
                        className={`px-6 py-2 rounded-full font-medium transition-all ${donationType === "one-time"
                      ...
                      <button
                        ...
                        className={`px-6 py-2 rounded-full font-medium transition-all ${donationType === "monthly"
                          ? "bg-gray-900 text-white shadow-md"
                          : "text-gray-600 hover:text-gray-900"
                          }`}
                      >
                  ...
                  <div className="mb-8">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4 text-center">
                      Select {donationType === "monthly" ? "Monthly" : ""} Donation Level
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-6">
                      {donationLevels.map((level) => (
                        <button
                          ...
                          className={`p-6 rounded-xl border-2 font-semibold transition-all text-left ${selectedAmount === level.amount && !customAmount
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-2xl font-bold">${level.amount}</span>
                            {donationType === "monthly" && <span className="text-sm text-gray-500">/month</span>}
                          </div>
                  ...
                  <div className="mb-8 p-6 bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl">
                    {(() => {
                      ...
                      if (selectedLevel && amount > 0) {
                        return (
                          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                            <div className="w-32 h-32 md:w-40 md:h-40 rounded-xl overflow-hidden shadow-lg flex-shrink-0">
                              <img
                            ...
                            <div className="text-center md:text-left flex-1">
                              <h5 className="text-xl font-semibold text-gray-900 mb-3">{selectedLevel.title}</h5>
                        ...
                        return (
                          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                            ...
                            <div className="text-center md:text-left flex-1">
                              <h5 className="text-xl font-semibold text-gray-900 mb-3">Custom Impact</h5>
                              <p className="text-gray-700 leading-relaxed text-lg">
                      ...
                      return <p className="text-center text-gray-600">Select a donation level or enter a custom amount to see your impact</p>
                    })()}
                  </div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Every Gift Creates Futures That Sing</h2>
