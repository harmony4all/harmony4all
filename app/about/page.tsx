...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative py-12 md:py-24 lg:py-32 bg-cover bg-top bg-no-repeat" style={{
      ...
      <section className="py-8 md:py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        {/* Background Pattern */}
            ...
            <div className="grid lg:grid-cols-2 gap-6 md:gap-12 lg:gap-16 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  {/* Floating Elements */}
                  <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 lg:-top-4 lg:-right-4 w-8 h-8 md:w-12 md:h-12 lg:w-20 lg:h-20 bg-black rounded-full flex items-center justify-center shadow-lg animate-bounce">
                    <Music className="h-4 w-4 md:h-6 md:w-6 lg:h-10 lg:w-10 text-white" />
                  </div>

                  <div className="absolute -bottom-1 -left-1 md:-bottom-2 md:-left-2 lg:-bottom-4 lg:-left-4 w-6 h-6 md:w-10 md:h-10 lg:w-16 lg:h-16 bg-black rounded-full flex items-center justify-center shadow-lg animate-pulse">
                    <Heart className="h-3 w-3 md:h-5 md:w-5 lg:h-8 lg:w-8 text-white" />
                  </div>
                </div>
                ...
                {/* Decorative Elements */}
                <div className="absolute top-1/4 left-0 w-4 h-4 md:w-6 md:h-6 lg:w-8 lg:h-8 bg-gray-400 rounded-full opacity-60 animate-ping"></div>
                <div className="absolute bottom-1/4 right-1/4 w-3 h-3 md:w-4 md:h-4 lg:w-6 lg:h-6 bg-gray-600 rounded-full opacity-60 animate-ping" style={{ animationDelay: '1s' }}></div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Mission Section */}
      <section className="py-8 md:py-16 lg:py-24 bg-gray-900 relative overflow-hidden">
      ...
      {/* Vision Section */}
      <section className="py-8 md:py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
              {/* Vision Card 1 */}
              <div className="bg-white rounded-2xl p-3 md:p-6 lg:p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
      ...
      {/* Values Section */}
      <section className="py-12 md:py-24 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center mb-8 md:mb-16">
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="bg-white rounded-2xl w-full md:w-[90%] p-4 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-4 -left-4 md:-top-6 md:-left-6 w-12 h-12 md:w-16 md:h-16 bg-black rounded-full flex items-center justify-center shadow-lg animate-bounce">
                  <Users className="h-6 w-6 md:h-8 md:w-8 text-white" />
                </div>
                <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 w-12 h-12 md:w-16 md:h-16 bg-black rounded-full flex items-center justify-center shadow-lg animate-bounce" style={{ animationDelay: '0.5s' }}>
                  <Target className="h-6 w-6 md:h-8 md:w-8 text-white" />
                </div>
                <div className="absolute top-1/2 -left-6 md:-left-8 w-10 h-10 md:w-12 md:h-12 bg-black rounded-full flex items-center justify-center shadow-lg animate-pulse">
                  <Award className="h-5 w-5 md:h-6 md:w-6 text-white" />
                </div>
                <div className="absolute top-1/2 -right-6 md:-right-8 w-10 h-10 md:w-12 md:h-12 bg-black rounded-full flex items-center justify-center shadow-lg animate-pulse" style={{ animationDelay: '1s' }}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6 md:space-y-8">
              {storyMilestones.map((milestone, index) => (
                <div
                  key={index}
                  className={`flex items-start space-x-4 md:space-x-6 transition-all duration-1000 hover:scale-105 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"
                    }`}
            ...
            <div
              className={`text-center mt-8 md:mt-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
