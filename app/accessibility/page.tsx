        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-sm md:text-lg lg:text-xl text-gray-600 leading-relaxed">
              <span className="font-bold  px-1 rounded">Harmony 4 All</span> is committed to ensuring digital accessibility for people with disabilities. We continually
            ...
            >
              <CardContent className="p-4 md:p-6 lg:p-8">
                <p className="text-sm md:text-base lg:text-lg text-gray-700 leading-relaxed mb-4 md:mb-6">
                  At <span className="font-bold  px-1 rounded">Harmony 4 All</span>, accessibility is not just a compliance requirement—it's a core value that reflects
                ...
                <CardContent className="p-4 md:p-6 lg:p-8">
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs md:text-sm lg:text-base text-gray-700">accessibility@harmony4all.org</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
